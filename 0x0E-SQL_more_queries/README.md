...
This is a project on SQL and relational databases. The aim is to learn how to create new users, manage privileges for the users, `PRIMARY KEY`, `FOREIGN KEY`, constraints, subqueries, `JOIN` and `UNION` with **MySQL**.
