...
The aim is to learn about variables, basics commands and handle strings with **Python**.
...
## Projects
Shell scripts and files written in Python:

| Filename | Description |
| -------- | ----------- |
| `0-run` | Shell script that runs a Python script, the name is saved in an environment variable |
