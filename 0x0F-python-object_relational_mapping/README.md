...
This project focuses on object-relational mapping for database scripting and using MySQLdb and SQLAlchemy to query, create, edit, and delete tables in MySQL.
